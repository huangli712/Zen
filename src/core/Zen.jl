...
# dcount_init  -> Initialize self-energy functions.
# dcount_run   -> Calculate double-counting terms and then substract them.
# dcount_save  -> Backup self-energy functions.
#
include("base.jl")
#
export ready
