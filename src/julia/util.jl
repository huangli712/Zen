...
function view_impurity()
    ...
    println("impurity -> nsite  -> ", PIMP["nsite"])
    println("impurity -> atoms  -> ", PIMP["atoms"])
    println("impurity -> equiv  -> ", PIMP["equiv"])
    println("impurity -> shell  -> ", PIMP["shell"])
    println("impurity -> occup  -> ", PIMP["occup"])
    println("impurity -> upara  -> ", dmft["impurity"]["upara"])
    println("impurity -> jpara  -> ", dmft["impurity"]["jpara"])
    println("impurity -> lpara  -> ", dmft["impurity"]["lpara"])
