...
function view_dft()
    ...
    println("dft  -> engine   -> ", PDFT["engine"])
    println("dft  -> smear    -> ", PDFT["smear"])
    println("dft  -> kgrid    -> ", PDFT["kgrid"])
    println("dft  -> lsymm    -> ", PDFT["lsymm"])
    println("dft  -> lspins   -> ", PDFT["lspins"])
    println("dft  -> lspinorb -> ", PDFT["lspinorb"])
    println("dft  -> window   -> ", PDFT["window"])
    println("dft  -> lopt     -> ", PDFT["lopt"])
    println("dft  -> lproj    -> ", PDFT["lproj"])
    println("dft  -> nproj    -> ", PDFT["nproj"])
    println("dft  -> sproj    -> ", PDFT["sproj"])
    println()
end
