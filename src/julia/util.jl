...
function view_dmft()
    ...
    println("dmft -> mode    -> ", PDMFT["mode"])
    println("dmft -> axis    -> ", PDMFT["axis"])
    println("dmft -> beta    -> ", PDMFT["beta"])
    println("dmft -> niter   -> ", PDMFT["niter"])
    println("dmft -> mixer   -> ", PDMFT["mixer"])
    println("dmft -> dcount  -> ", PDMFT["dcount"])
    println("dmft -> cc      -> ", PDMFT["cc"])
    println("dmft -> ec      -> ", PDMFT["ec"])
    println("dmft -> fc      -> ", PDMFT["fc"])
    println("dmft -> lcharge -> ", PDMFT["lcharge"])
    println("dmft -> lenergy -> ", PDMFT["lenergy"])
    println("dmft -> lforce  -> ", PDMFT["lforce"])
    println()
end
